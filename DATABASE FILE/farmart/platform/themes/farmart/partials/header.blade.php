                ...
                <div class="container-xxxl">
                    <div class="header-wrapper">
                        ...
                        <div class="header-items header__center">
                            {{-- @if (is_plugin_active('ecommerce'))
[simple-slider key="home-slider" is_autoplay="yes" autoplay_speed="5000" ads="VC2C8Q1UGCBG" background="general/slider-bg.jpg"][/simple-slider]                                <form class="form--quick-search" action="{{ route('public.products') }}" data-ajax-url="{{ route('public.ajax.search-products') }}" method="get">
