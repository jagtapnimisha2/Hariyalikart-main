...
@section('main-content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="nice-select" name="country" id="country" required style="margin-left: 10px;">
    ...
    <div class="checkbox">
        ...
        <form-group>
            {{-- <input name="payment_method"  type="hidden" value="cod"> <label> Cash On Delivery</label><br> --}}
                ...
                <div class="card-body text-center">
                    <form action="{{ route('payment') }}" method="POST" >
                        ...
                        <script src="https://checkout.razorpay.com/v1/checkout.js"
                                ...
                                data-amount={{$total_amount}}00
                                {{-- data-buttontext="Pay 10 INR" --}}
                                data-name="haryalikart.com"
                                data-description="Rozerpay"
                                data-image=@foreach($settings as $data) {{asset("$data->logo")}} @endforeach
